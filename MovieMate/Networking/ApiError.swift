...
extension ApiError {
    var errorInfo: ErrorInfo {
        switch self {
        case .incorrectId: ErrorInfo("Некорректный ID",
                                     "Введите корректный ID комнаты",
                                     "Хорошо")
        case .unableToCreateLobby: ErrorInfo("Не удалось создать лобби",
                                             "Проверьте интернет",
                                             "Хорошо")
        case .unableToDeleteLobby: ErrorInfo("Не удалось удалить лобби",
                                             "Проверьте интернет",
                                             "Хорошо")
        case .unableToStartLobby, .unableToRestartLobby: ErrorInfo("Не удалось начать игру",
                                                                   "Проверьте интернет",
                                                                   "Хорошо")
        case .unableToGetGenres: ErrorInfo("Не удалось получить жанры",
                                           "Проверьте интернет",
                                           "Хорошо")
        case .unableToConfirmGenres: ErrorInfo("Не удалось подтвердить жанры",
                                               "Проверьте интернет",
                                               "Хорошо")
        case .unableToGetMovies: ErrorInfo("Не удалось получить фильмы",
                                           "Проверьте интернет",
                                           "Хорошо")
        }
    }
